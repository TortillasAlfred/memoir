...
Un bandit multi-bras stochastique (MAB) est un problème pour lequel on a un ensemble
...
\todo{Cette section va être à retoucher selon les commentaires de Luc.
    Pas encore modifié car pas prioritaire pour le moment.}
